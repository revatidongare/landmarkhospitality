...
<body>
    ...
    <!-- SubHeader =============================================== -->
    <section class="parallax-window" id="short" data-parallax="scroll" data-image-src="../img/sub_header_short.jpg" data-natural-width="1400" data-natural-height="550">
        <div id="subheader">
            <h1>Our Rooms</h1>
    </div><!-- End subheader -->
    </section><!-- End section -->
                        ...
                        <ul>
                            ...
                            <div class="tooltip_styled tooltip-effect-4">
                            	<span class="tooltip-item"><i class="icon_set_2_icon-104"></i></span>
                                	<div class="tooltip-content">Bed</div>
                              </div>
                              </li>
                            <li>
                            <div class="tooltip_styled tooltip-effect-4">
                            	<span class="tooltip-item"><i class="icon_set_1_icon-86"></i></span>
                                	<div class="tooltip-content">Wi-fi Internet Connectivity</div>
                              </div>
                              </li>
                            <li>
                            <div class="tooltip_styled tooltip-effect-4">
