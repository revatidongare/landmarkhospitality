				...
				<form method="post" action="back.php">
					...
					<div class="row">
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
								<label>Email</label>
								<input type="email" id="email" name="email_contact" class="form-control" placeholder="Enter Email">
							</div>
						</div>
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
								<label>Phone</label>
								<input type="text" id="phone" name="phone_contact" class="form-control" placeholder="Enter Phone number">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
                                ...
                                <input type="text" id="room" name="room" class="form-control" placeholder="Enter Phone number">
					...
					<div class="row add_bottom_30">
						<div class="col-md-6">
                        	<div class="form-group">
                                ...
                                <input type="date" id="arrival" class="form-control add_bottom_30" >
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" id="departure" class="form-control add_bottom_30" >
                            </div>
                            <button type="submit" id="bookroom" name="bookroom"></button>
                        </div>
					</div>
